...
async function convertFiles() {
    ...
    try {
        ...
        for (const file of filesToConvert) {
            ...
            const tiffBlob = await convertToTiff(imgElement);
            convertedFiles.push(tiffBlob);
        }
...
function convertToTiff(imgElement) {
...
function createSingleDownloadLink(blob) {
    ...
    downloadButton.download = `${originalFilename}_prepphint.com.tiff`;
}
...
function createDownloadLink(blobs) {
    ...
    blobs.forEach((blob, index) => {
        ...
        zip.file(`${originalFileName}_prepphint.com.tiff`, blob);
    });
